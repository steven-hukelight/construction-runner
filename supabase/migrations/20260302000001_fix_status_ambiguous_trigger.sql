-- Fix "column reference status is ambiguous" (42702)
-- users table has a 'status' column; the trigger variable had the same name.
-- Rename variable to new_status to resolve ambiguity.
