-- Fix COALESCE type mismatch in perform_attendance_fallback(): attendance.timestamp may be
-- text or timestamp without time zone; cast with ::timestamptz for coalesce/extract.
-- Version timestamp 20260408120000 so this runs after 20260407120000_fix_perform_attendance_fallback_elapsed_sec.
