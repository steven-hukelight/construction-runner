-- Fix perform_attendance_fallback(): do not overwrite elapsed_sec incorrectly; log line matches stale_ok.
-- Also avoids carrying elapsed_sec from a previous loop row when stale_ref IS NULL (ELSE branch).
