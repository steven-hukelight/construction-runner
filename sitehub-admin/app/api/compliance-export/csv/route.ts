...
import { buildCsvString } from "@/app/dashboard/induction-compliance/utils/buildCsvString";
...
export async function GET(req: Request) {
  try {
    ...
    const csv = buildCsvString(dataset);
    ...
    console.error("GET /api/compliance-export/csv:", message);
