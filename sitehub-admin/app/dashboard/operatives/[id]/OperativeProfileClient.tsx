      ...
      {user && (user.addressLine1 || user.town || user.postcode || user.emergencyContactName || user.jobTitle || user.nationalInsurance) && (
        <div className="card">
          ...
          <div className="mt-3 space-y-2 text-sm">
            ...
            {user.jobTitle && (
              <div><span className="font-medium text-slate-600">Job title: </span>{user.jobTitle}</div>
            )}
            ...
            {user.nationalInsurance && (
              <div><span className="font-medium text-slate-600">NI number: </span>{user.nationalInsurance}</div>
            )}
            {user.utr && (
              <div><span className="font-medium text-slate-600">UTR: </span>{user.utr}</div>
            )}
            {user.dateOfBirth && (
              <div><span className="font-medium text-slate-600">DOB: </span>{new Date(user.dateOfBirth).toLocaleDateString("en-GB")}</div>
            )}
          </div>
        </div>
      )}
