...
1. **API URL** – For production, build with `--dart-define=SITEHUB_API_URL=https://construction-runner.vercel.app` (or your deployed admin URL).  
   If you deploy the web app elsewhere, use that URL as the API base.
